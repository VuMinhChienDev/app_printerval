...
//   const [comments, setComments] = useState<Array<{ id: number; text: string; date: string }>>([])
...
//             <Ionicons name={isInWishlist ? "heart" : "heart-outline"} size={30} color={isInWishlist ? "red" : "gray"} />
//           </TouchableOpacity>
//         </View>
...
//                 >
//                   <Text style={[styles.genderText, selectedGender === gender && styles.selectedOptionText]}>
//                     {gender}
//                   </Text>
//                 </TouchableOpacity>
//               ))}
